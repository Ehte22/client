...
import { Box, Button, Card, CardContent, Divider, Grid, IconButton, Paper, Table, TableBody, TableCell, TableContainer, TableHead, TableRow, Typography } from '@mui/material'
...
const DashBoard = () => {
    return <>
        <Box>
            ...
            <Box>
                <Grid container >
                    <Grid item md={3} lg={2.5} sx={{ paddingLeft: '36px', paddingY: '50px', display: { xs: 'none', md: 'block' } }}>
                        <Box>
                            <Typography sx={{
